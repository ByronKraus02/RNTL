...
import { ArrowLeft, MapPin, Phone, Calendar as CalendarIcon, CreditCard } from "lucide-react";
...
export default function EquipmentDetails() {
  ...
  // ✅ Replace base44.entities.Equipment.filter()
  ...
  // ✅ Replace base44.entities.Booking.create()
  ...
  const handleBooking = async () => {
    if (!user) {
      navigate(createPageUrl("Login") + "?redirect=" + window.location.pathname + window.location.search);
      return;
    }
  ...
  return (
    <div className="max-w-6xl mx-auto px-6 py-8 bg-black min-h-screen">
      ...
      {success && (
        <Alert className="mb-6 bg-green-900/50 border-green-600">
          <AlertDescription className="text-green-300">
            ✅ Booking confirmed! Payment held in escrow. Redirecting to your bookings...
          </AlertDescription>
        </Alert>
      )}
      ...
      <div className="grid lg:grid-cols-2 gap-8">
        ...
        <div className="space-y-6">
          <div>
            <h1 className="text-3xl md:text-4xl font-bold text-white mb-3">{equipment.name}</h1>
            <div className="flex items-center gap-4 mb-4">
              <div className="text-3xl font-bold text-cyan-400">R{equipment.price_per_day}</div>
                ...
                <div className="bg-gray-800 p-4 rounded-2xl border border-gray-700">
                  ...
                  <div className="border-t border-gray-700 pt-2 mt-2">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-2xl font-bold text-cyan-400">R{calculateTotal()}</span>
                    </div>
